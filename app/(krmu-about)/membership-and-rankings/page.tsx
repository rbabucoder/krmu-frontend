            ...
            {members &&
              members.map((member) => {
                return (
                  <div
                    key={member?.id}
                    className="bg-white text-center h-[431px] flex flex-col items-center rounded-4xl membership-ranking-card p-5 md:p-0"
                  >
                    <Link href={member?.cardurl}>
                      <Image
                    ...
                    <Link href={member?.cardurl} className="font-bold text-2xl">
                      {member.cardtitle}
                    </Link>
                  </div>
                );
