...
const programmes = [
  {
    ...
    `,
    eligibility: `
      * Admission to Ph.D. programmes is through KRMU-PET or NET Score followed by interview.<br />
* Written Exam is Exempted for UGC-JRF/CSIR-UGC-JRF/M.Phil. qualified candidates.<br /><br />
