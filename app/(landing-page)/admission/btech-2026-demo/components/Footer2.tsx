    ...
    >
      <div className="px-6 max-w-[1200px] mx-auto w-full">
        <div className="text-center max-w-[700px] m-auto">
          <h2 className="text-black mb-4 text-2xl md:text-4xl font-bold leading-[1.2]">
            The Best Time to Start
            <br />
            Was Yesterday. The Next Best? Now.
          </h2>
          <p className="text-black text-lg mb-8">
            Limited scholarships available. January 15 deadline. 92% placement
            rate waiting for you on the other side.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 items-center mb-10">
            <a
              ...
              transistion-all duration-150 ease-out py-4 px-6 hover:-translate-y-0.5 hover:shadow-[0_6px_20px_0_rgba(227,30,36,0.45)] hover:bg-[linear-gradient(135deg,#ff4d52_0%,#e31e24_100%)]"
            >
