...
import { llm2026Id, ma2026Id } from "../constant/lpnpf";
import {
  aboutUsContent,
...
const page = () => {
  const maFormId = ma2026Id;
  const { title, description, primaryCta, secondaryCta, image, bgImage, ugHeroClsName} =
    heroContent;
  ...
  return (
    <>
      ...
      <BusinessHub data={businessData} formId={maFormId} />
