...
export const aboutUsContent: AboutUsContent = {
  title: "About Us",
  description: `<p>Established in 2013 under the Haryana Private University Act, K.R. Mangalam University is a leading institution of higher education in Gurugram. Accredited with NAAC Grade ‘A’, the University reflects a strong commitment to academic excellence, quality teaching, and continuous improvement.</p> <br /> 
  <p>The University’s M.A. programmes in English, Economics, Political Science, and Applied Psychology are designed to offer strong theoretical foundations, research-oriented learning, and practical exposure. These programmes equip students with critical thinking abilities, analytical skills, and subject expertise, preparing them for diverse professional roles, civil services, research, and advanced academic pursuits.
</p>`,
  image: {
...
export const PGTestimonialsData: PGTestimonialsBlock = {
  header: {
    ...
    title: "Why Do Our Students Trust Us?",
    highlight: "",
  },
  ...
  items: [
    ...
    {
      brand: "",
      text: "My journey at KRMU has been nothing short of a fun rollercoaster. It was an amalgamation of learning, joyful experiences and holistic personality development. I was lucky enough to get the support of my really helpful professors who were a guiding light at all points. My achievements were always given recognition. I was appreciated by everyone around me that gave me further boost up to excel in all fields. The Chancellor’s Excellence Award and a 100% sponsored trip to United Kingdom will always be close to my heart and I will always cherish my “good-old” days with K.R.Mangalam!",
      author: "Arshleen Sodhi",
      color: "bg-white",
      featured: false,
    },
    {
...
export const faqSectionData: FAQSectionData = {
  ...
  faqs: [
    ...
    {
      id: "item-2",
      question: "Can students get scholarships for M.A. courses at K.R. Mangalam University?",
    ...
    },
    {
      ...
      answer: `K.R. Mangalam University offers the following M.A. courses: 
      <ul>
        <li>M.A. English</li>
        <li>M.A. Economics</li>
