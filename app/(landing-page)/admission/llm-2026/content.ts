...
export const businessLeaderContent: BusinessLeaderContent = {
  sectionTitle: "Empowering the Next Generation of Legal Thought Leaders",
...
export const comeToLifeData: ComeToLifeSection = {
  heading: `World-Class Facilities for LL.M. at KRMU`,
  description: `K.R. Mangalam University provides a supportive and resource-rich environment for LL.M. students, featuring modern law classrooms, a well-stocked central library with extensive legal databases and research resources, and dedicated research centres to support advanced legal study.`,
  footerText: ``,
  cta: {
