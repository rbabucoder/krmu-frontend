    ...
    >
      <div className="px-3 flex justify-between items-center gap-3">
        ...
        <div className="w-1/2 hidden sm:flex justify-end">
          {/* <button className="max-w-[180px] w-full py-compact px-[25px] text-white bg-krmu-red rounded-[15px]">
            Apply Now
          </button> */}
          <ScrollButton targetId="apply-section" highlightClass="flash-border" btnClass="max-w-[180px] w-full py-compact px-[25px] text-white bg-krmu-red rounded-[15px]" >
            Apply Now
          </ScrollButton>
        </div>
      </div>
