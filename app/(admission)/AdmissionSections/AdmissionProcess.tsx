          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-3xl md:text-4xl lg:text-5xl mb-6 text-gray-800 font-bold">
                Admission <span className="text-university-red">Process</span>
              </h2>
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Your journey to excellence begins here. Follow our simple 4-step
                admission process to join K.R. Mangalam University and transform
                your future.
              </p>
            </div>
            ...
            <div className="text-center">
              <div className="max-w-2xl mx-auto mb-6 md:mb-8">
                ...
                <p className="text-gray-600">
                  Start your application today and take the first step towards a
                  successful future at K.R. Mangalam University.
                </p>
              </div>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6 md:mb-8">
                <button className="bg-university-red hover:bg-red-600 text-white px-8 md:px-12 py-3 md:py-4 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg text-base md:text-lg">
                  Start Your Application
                </button>
                <button className="border-2 border-blue-400 text-blue-500 hover:bg-blue-400 hover:text-white px-6 md:px-8 py-3 md:py-4 rounded-full transition-all duration-300 text-base md:text-lg">
                  Download Brochure
                </button>
              </div>
              <p className="text-sm text-gray-500">
                Need help? Contact our admission counselors at{" "}
                <span className="text-red-500">+91-11-48884888</span>
              </p>
            </div>
