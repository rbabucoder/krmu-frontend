    ...
    <>
      <Tabs defaultValue="advisoryboard">
        <div className="flex justify-center">
          <TabsList className="h-36 lg:h-24 faculty-with-advisory flex flex-col lg:flex-row max-w-[300px] w-full md:max-w-fit">
            <TabsTrigger
              value="advisoryboard"
              className="cursor-pointer break-all py-2.5 px-[100px] text-2xl rounded-[48px] data-[state=active]:w-[300px] md:data-[state=active]:w-full data-[state=active]:bg-[#051630]  data-[state=active]:text-white"
            >
              Advisory Board
            </TabsTrigger>
            <TabsTrigger
