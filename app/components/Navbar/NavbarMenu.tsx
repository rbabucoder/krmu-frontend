  ...
  return (
    <>
        <ul className="flex items-center gap-2.5">
            ...
            <li><Link className="font-semibold text-xs 2xl:text-[15px] text-white flex items-center gap-2.5" href="/admission"><span>Admissions</span> {/*<Image src="/white-down-chevron.svg" alt="white chevron" width={11} height={11} /> */}</Link></li>
