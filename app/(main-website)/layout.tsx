...
export const metadata: Metadata = {
  title: "KR Mangalam University | Top Private University in Haryana",
  description: "KR Mangalam University, Gurugram – NAAC A-grade accredited private university offering undergraduate, postgraduate, and doctoral programmes across Engineering, Management, Law, Health Sciences, and more.",
  verification: {
