          ...
          {pdfCards &&
            pdfCards?.map((item, i) => {
              return (
                <div
                  key={i}
                  className="p-5 bg-[url(/phd-regulation/rectangle.webp)] bg-cover bg-no-repeat rounded-pill text-white flex flex-col items-center justify-center"
                >
                  <div
                  ...
                  <div>
                    {item?.pdf_btn?.btn_link && (
                      <Link
                        ...
                        className="bg-krmu-red text-white py-[9px] px-5 text-xs leading-3.5 inline-block rounded-badge font-medium"
                        target="_blank"
                      >
