...
const ContactVisitOurLocation = () => {
  return (
    <section className="py-20 px-4">
      <div className="max-w-main mx-auto w-full flex flex-col lg:flex-row bg-[url(/contact-us/campus-bg.webp)] bg-cover bg-no-repeat bg-center   lg:h-80 items-end rounded-[16px]">
        <div className="lg:w-1/2 text-white h-full p-10">
          ...
          >
            {" "}
            <div className="campus-text text-black font-semibold text-h5">
              {" "}
              Schedule Your Exclusive{" "}
              <span className="text-krmu-blue">Campus Tour Today! </span>{" "}
            </div>{" "}
            <Image
