      ...
      <Tabs defaultValue="advisoryboard">
        <div className="flex justify-center">
          <TabsList className="h-36 lg:h-24 faculty-with-advisory">
            <TabsTrigger
              value="advisoryboard"
              className="cursor-pointer break-all py-2.5 px-[100px] text-2xl rounded-[48px]  data-[state=active]:bg-krmu-navy  data-[state=active]:text-white"
            >
              Advisory Board
            </TabsTrigger>
            <TabsTrigger
        ...
        <div className="pt-section-lg pb-36">
