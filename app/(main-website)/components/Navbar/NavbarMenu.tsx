  ...
  return (
    <>
        ...
        <ul className="flex items-center gap-2.5">
          {academicMenu && (
            <li className="relative krm-sub-menu-has-children">
              ...
              <div className="absolute flex right-0 translate-x-[80%] 2xl:translate-x-[50%] min-w-[1000px] w-full krmsubmenu-container krmsubmenu-1">
                <div className="rounded-l-sm bg-white w-3/5 pt-section-sm px-container-px pb-[15px] flex">
                  <div className="pr-[30px] border-r border-[#d9dada]">
                    <h5 className="text-lg text-krmu-navy my-2.5 font-semibold">
                    ...
                    <ul>
                      {academicMenu?.academicmenu?.menulinks.map((menu) => {
                        return (
                          <li
                            key={menu?.id}
                            className={`text-body-sm capitalize pb-[7px] hover:text-blue-700 ${
                              menu?.menuclass || ""
                            }`}
                          >
                            <Link href={`${menu?.url || "#"}`}>
                  ...
                  <div className="ml-[15px] px-container-px">
                    <h5 className="text-lg text-krmu-navy my-2.5 font-semibold">
                ...
                <div
                  className="w-2/5 px-container-px bg-cover bg-center bg-no-repeat relative krmsubmenu-img-container flex items-end rounded-r-[10px]
               overflow-hidden"
                  style={{
          ...
          {admissionMenu && (
            <li className="relative krm-sub-menu-has-children">
              ...
              <div className="absolute flex right-0 translate-x-[50%] min-w-[1000px] w-full krmsubmenu-container krmsubmenu-2">
                ...
                <div
                  className="w-2/5 px-container-px  bg-cover bg-center bg-no-repeat relative krmsubmenu-img-container flex items-end rounded-r-[10px] overflow-hidden"
                  style={{
          ...
          {placementMenu && (
            <li className="relative krm-sub-menu-has-children">
              ...
              <div className="absolute flex right-0 translate-x-[50%] min-w-[1000px] w-full krmsubmenu-container krmsubmenu-2">
                <div className="rounded-l-sm bg-white w-1/2 pt-section-sm px-container-px pb-[15px] flex">
                ...
                <div
                  className="w-1/2 px-container-px bg-cover bg-center bg-no-repeat relative krmsubmenu-img-container flex items-end rounded-r-[10px]
               overflow-hidden"
                  style={{
          ...
          {researchMenu && (
            <li className="relative krm-sub-menu-has-children">
              ...
              <div className="absolute flex right-0 translate-x-[20%] min-w-[1000px] w-full krmsubmenu-container krmsubmenu-2">
                <div className="w-1/2 px-container-px bg-[url(/menu-4.webp)] bg-cover bg-center bg-no-repeat relative krmsubmenu-img-container flex items-end rounded-l-[10px] overflow-hidden">
                ...
                <div className="rounded-r-[10px] bg-white w-1/2 pt-section-sm px-container-px pb-[15px] flex justify-center items-center">
                  <div className="pr-[30px] min-h-[]">
                    ...
                    <ul className="mb-5">
                      ...
                      {/* <li className="text-body-sm capitalize pb-[7px] hover:text-blue-700 relative">
                      ...
                      <li className="text-body-sm capitalize pb-[7px] hover:text-blue-700">
          ...
          {lifeatkrmuMenu && (
            <li className="relative krm-sub-menu-has-children">
              ...
              <div className="absolute flex right-0 translate-x-[20%] min-w-[1000px] w-full krmsubmenu-container krmsubmenu-2">
                <div
                  className="w-2/5 px-container-px bg-[url(/menu-5.webp)] bg-cover bg-center bg-no-repeat relative krmsubmenu-img-container flex items-end rounded-l-[10px] 
                overflow-hidden"
                  style={{
                ...
                <div className="rounded-r-[10px] bg-white w-3/5 pt-section-sm px-container-px pb-[15px] flex">
          ...
          {aboutusMenu && (
            <li className="relative krm-sub-menu-has-children">
              ...
              <div className="absolute flex right-0 min-w-[1000px] w-full krmsubmenu-container krmsubmenu-1">
                <div
                  className="w-1/2 px-container-px bg-[url(/menu-6.webp)] bg-cover bg-center bg-no-repeat relative krmsubmenu-img-container flex items-end rounded-l-[10px] 
                overflow-hidden"
                  style={{
            ...
            applyNowButton.__component === "menu.menu-button" && (
              <li>
                <Link
                  ...
                  className={`bg-krmu-red-dark py-2 px-[22px]  text-xs font-medium text-white rounded-[5px] ${
      ...
      {applyNowButton && applyNowButton.__component === "menu.menu-button" && (
        <Link
          href={applyNowButton?.url || "#"}
          className={`bg-krmu-red-dark py-2 px-[22px] inline-block text-xs font-medium text-white rounded-[5px] xl:hidden ${
            applyNowButton?.class || ""
          }`}
        >
          {applyNowButton?.title}
