...
const SchoolAdmissionOpen = ({ title, admBtn }: Props) => {
  return (
    <div className="px-5">
      <div
        className="max-w-[1600px] mx-auto w-full py-7 sm:py-8 px-5 bg-white rounded-4xl flex flex-col items-center justify-center gap-4 -mt-14 mb-10 z-50 relative"
        style={{
