...
const page = () => {
  return (
    <>
      <section className="pt-hero-top lg:pt-[15%] pb-[10%] bg-[url(/infra.webp)] bg-cover bg-no-repeat bg-center common-overlay">
        <div className="max-w-main mx-auto w-full">
          <h1 className="text-3xl md:text-5xl lg:text-display relative z-10 text-white font-semibold text-center px-4">
            Counselling & Mental Wellbeing Centre (We Dost)
          </h1>
        </div>
      </section>
      <section>
        <div className="max-w-main mx-auto w-full py-10 flex flex-col lg:flex-row px-4 gap-5 lg:gap-10">
      ...
      <section>
        <div className="max-w-main mx-auto w-full py-10  px-4">
          <h3 className="text-2xl font-semibold mb-5">Our Objectives</h3>
          <div className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-1/2">
              <ul className="flex flex-col gap-2.5">
                <li className="flex items-center gap-5">
                  <span className="bg-krmu-navy p-1.5 rounded-full">
      ...
      <section>
        <div className="max-w-main mx-auto w-full py-10 px-4 flex flex-col lg:flex-row">
          <div className="w-full lg:w-1/3">
      ...
      <section>
        <div className="max-w-main mx-auto w-full py-10 px-4 flex flex-col lg:flex-row gap-5 lg:gap-10">
          <div className="w-full lg:w-1/3">
      ...
      <section>
        <div className="max-w-main mx-auto w-full py-10 px-4 break-all sm:break-normal">
      ...
      <section>
        <div className="max-w-main mx-auto w-full flex justify-center py-10 px-4">
