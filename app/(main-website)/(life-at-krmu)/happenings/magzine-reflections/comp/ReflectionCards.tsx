...
const ReflectionCards = ({ magazinecards }: Props) => {
  return (
    <>
      <div className="max-w-[1910px] mx-auto w-full py-5 px-4 md:py-section-lg md:px-container-px grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
        {magazinecards &&
