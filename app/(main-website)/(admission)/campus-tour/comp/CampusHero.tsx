...
const CampusHero = () => {
  return (
    <section className="pt-hero-top px-4 md:pt-[9%] pb-20 md:pb-10 bg-[url(/campus/campusbg.webp)] bg-cover bg-no-repeat bg-center">
      <div className="max-w-main mx-auto w-full flex flex-col lg:flex-row gap-5">
        <div className="lg:w-1/2 text-white">
          <h1 className="text-2xl md:text-5xl font-semibold leading-[1.2] md:leading-[1.5] mb-5">
            ...
            <span className="text-krmu-red-dark">Campus Tour</span> Today!
          </h1>
          <p>
      ...
      <div className="max-w-main mx-auto w-full flex flex-col md:flex-row mt-10 md:mt-0 gap-20">
        <div className="lg:w-1/3 text-white md:pt-section md:px-[35px] md:pb-[35px]">
