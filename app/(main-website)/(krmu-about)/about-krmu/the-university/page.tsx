  ...
  return (
    <>
      <section className="min-h-[1px] h-full pt-44 lg:h-[600px] bg-[url(/krmabout.webp)] bg-cover bg-bottom relative prog-banner-shade">
        <div className="max-w-wide mx-auto w-full text-white h-full flex flex-col justify-center px-4">
          <div className="z-10 max-w-7xl w-full">
            <h1 className="text-2xl md:text-6xl xl:text-8xl font-semibold mb-5">
              {aboutData?.title}
            </h1>
            <p className="text-lg md:text-h5 mb-10">
              {aboutData?.subtitle}
            </p>
          </div>
        </div>
      ...
      <section className="mt-5 bg-krmu-navy py-section-lg px-4 xl:px-14">
      ...
      <section className="py-section px-4 xl:px-container-px bg-[#000E8B1A]">
        <div className="flex flex-col md:flex-row max-w-wide mx-auto w-full gap-2.5">
          <div className="w-full md:w-2/5 p-5 xl:mr-2.5 xl:ml-8 bg-[url(/aboutvision.webp)] text-white bg-cover">
            <h4 className="text-3xl md:text-5xl mb-5 lg:text-display font-semibold">
      ...
      <section className="py-10 sm:py-20 px-4 md:px-container-px">
        <div className="max-w-wide mx-auto w-full">
          <div className="flex flex-wrap xl:flex-nowrap  gap-5 w-full">
            ...
            <div className="w-full xl:w-1/3">
              <div className="bg-[url(/stellar.webp)] bg-cover pt-40 md:pt-[440px] pb-section-sm px-2.5 xl:px-container-px h-full text-white flex flex-col justify-end font-semibold">
            ...
            <div className="w-full xl:w-1/3">
              <div className="bg-[url(/finance-assist.webp)] bg-no-repeat bg-cover pt-40 px-4 md:pt-[440px] pb-section-sm md:px-container-px h-full text-white flex flex-col justify-end font-semibold w-full">
                <h4 className="text-3xl md:text-5xl mb-5">
                  Financial <br />
                  Assistance
                </h4>
          ...
          <div className="flex flex-col md:flex-row mt-5 gap-5">
            <div className="w-full md:w-1/2">
              <div className="bg-[url(/student.webp)] pt-32 xl:pt-64 pb-section-sm px-container-px text-white bg-cover h-full">
            ...
            <div className="w-full md:w-1/2">
              <div className="bg-[url(/andi.jpg)] bg-cover pt-32 xl:pt-64 pb-section-sm px-container-px text-white  h-full">
      ...
      <section className="py-16 bg-[url(/kree-bg.webp)] bg-cover">
        <div className="max-w-wide mx-auto w-full text-center">
          ...
          <Link
            ...
            className="p-2.5 px-[18px] bg-white text-base inline-block rounded-sm leading-4 text-krmu-red-dark"
          >
            Know More
          </Link>
        </div>
            ...
            <div className="w-full md:w-3/5">
              ...
              {(aboutData?.internationcollaboration?.intcollabbtn?.buttonlink ||
                ...
                <Link
                  ...
                  className={`p-2.5 px-[18px] bg-krmu-red-dark text-base inline-block rounded-sm leading-4 text-white ${aboutData?.internationcollaboration?.intcollabbtn?.buttonclass}`}
                  target="_blank"
                >
                  {
                    aboutData?.internationcollaboration?.intcollabbtn
      ...
      <section className="py-16 md:py-32 px-4 bg-[url(/krmu-committee.webp)] bg-cover bg-center relative after:content-[''] after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-[#00000080]">
        <div className="max-w-wide mx-auto w-full text-white">
          <div className="w-full xl:w-1/2 relative z-10">
            <h4 className="text-5xl lg:text-hero mb-5 leading-[1.13]">
            ...
            {(aboutData?.krmucommittee?.committeebtn?.buttonlink ||
              ...
              <Link
                ...
                className={`mt-5 p-2.5 px-[18px] bg-krmu-red-dark text-base inline-block rounded-sm leading-4 text-white ${aboutData?.krmucommittee?.committeebtn?.buttonclass}`}
              >
