    ...
    <section className="pt-36 md:pt-[9%] pb-[5%] bg-[url(/intcollab/mobilebanner.webp)] md:bg-[url(/intcollab/rankbg.webp)] bg-cover bg-no-repeat bg-center px-4">
      <div className="max-w-main mx-auto w-full text-white">
        <div className="lg:mx-[1.92%]">
          <div className="text-4xl md:text-6xl lg:text-hero font-semibold leading-[1] mb-5">
          ...
          {heroBtn?.buttonlink || heroBtn?.buttonclass ? (
            <Link
              ...
              className={`py-[11px] px-[23px] bg-white text-krmu-red text-body-sm font-semibold rounded-[5px] inline-block leading-[1] hover:bg-krmu-navy-light hover:text-white
          ...
          <div className="grid gap-5 md:gap-10 grid-cols-1 lg:gap-0 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <div className="p-[30px] text-white md:min-h-[380px] rounded-card h-full bg-krmu-navy lg:mr-[7.68%]">
              <p className="leading-[2]">{heroGrid[0]?.content}</p>
            </div>
            <div className="p-[30px] text-white md:min-h-[380px] rounded-card h-full bg-krmu-navy lg:mx-[7.68%]">
              <p className="leading-[2]">{heroGrid[1]?.content}</p>
            </div>
            <div className="p-[30px] text-white md:min-h-[380px] rounded-card h-full bg-krmu-navy lg:ml-[7.68%]">
