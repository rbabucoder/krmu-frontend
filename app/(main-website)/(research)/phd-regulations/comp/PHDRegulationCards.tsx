  ...
  return (
    <div className="py-10">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-16">
        <div className="bg-[url(/phd-regulation/rectangle.webp)] bg-cover bg-no-repeat bg-center p-5 flex items-center justify-center text-white rounded-pill">
          <ul className="text-center flex flex-col gap-2.5 text-lg">
            <li className="relative">
              <div className="hover:text-krmu-blue-light">
            ...
            <li>
              <Link
                className="hover:text-krmu-blue-light"
        ...
        <div className="bg-[url(/phd-regulation/rectangle.webp)] bg-cover bg-no-repeat bg-center p-5 flex items-center justify-center text-white rounded-pill">
          <ul className="text-center flex flex-col gap-2.5 text-lg">
            <li className="relative">
              <Link href="/PDF/regulations-2" className="hover:text-krmu-blue-light">
        ...
        <div className="bg-[url(/phd-regulation/rectangle.webp)] bg-cover bg-no-repeat bg-center p-5 flex items-center justify-center text-white rounded-pill">
          <ul className="text-center flex flex-col gap-2.5 text-lg">
            <li className="relative">
              <Link href="/PDF/syllabus" className="hover:text-krmu-blue-light">
      ...
      <div className="flex w-full break-all  items-center justify-center pt-10">
        <div className="bg-[url(/phd-regulation/rectangle.webp)] bg-cover bg-no-repeat bg-center p-5 flex flex-col items-center justify-center text-white rounded-pill">
