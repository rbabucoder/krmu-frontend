...
const ProgrammeHighlightCard = ({ title, desc, highlightimg }: Props) => {
  return (
    <>
      <div className="proghighcard flex justify-center cursor-pointer rounded-card">
        <div className="w-1/5">
          {highlightimg?.url && (
            <Image
              width={127}
        ...
        <div className="w-4/5 py-2.5 pr-2.5 pl-5">
          <h5 className="text-xl text-krmu-blue-dark hover:text-krmu-red-dark font-medium leading-[1.2] mb-2.5">
            {title}
          </h5>
