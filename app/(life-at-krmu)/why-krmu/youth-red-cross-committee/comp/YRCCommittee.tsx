    ...
    <section className="pt-[6%] px-4 pb-[9%] bg-[url(/bg-gradient.webp)]">
      <div className="max-w-[1664px] mx-auto w-full text-white ">
        ...
        <p>
          ...
          energy, fostering an environment of mutual respect and cooperation.
          This interaction between generations promotes the exchange of
          knowledge and skills, with experienced Red Cross volunteers offering
          valuable mentorship. This synergy is essential for nurturing the next
          generation of leaders today.
        </p>
        <br />
        <p>
          The YRC initiatives help the Indian Red Cross Society to uphold and
          implement the core principles of the Movement by focusing on:
        </p>
        <ul className="list-disc pl-10 my-2.5">
          <li>International Humanitarian Law</li>
          <li>Protection of health and life</li>
