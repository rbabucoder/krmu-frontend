const OverviewImpacting = () => {
  return (
    <div className="bg-[url(/gradient-3.webp)] bg-cover bg-center bg-no-repeat pt-[60px] px-[30px] flex gap-10 items-center">
      <div className="w-1/3 text-white">
        <h4 className="text-[32px]">Making a Difference Together</h4>
        <h3 className="text-8xl font-bold my-2.5">Impacting Lives</h3>
        <p>
          <strong>
      ...
      <div className="w-2/3">
        <div className="flex gap-10 impactinglivescard">
          <div
            className="w-1/3 text-white p-5 rounded-[25px]"
            style={{
