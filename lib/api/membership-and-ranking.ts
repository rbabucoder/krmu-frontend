...
> {
  const res = await fetch(
    `${STRAPI_URL}/api/membership-and-ranking?populate[memberships][fields][0]=cardurl&populate[memberships][fields][1]=cardtitle&populate[memberships][populate][cardimg]=true&populate[rankings][fields][0]=title&populate[rankings][populate][cardimg]=true`,
    {
      next: {
        revalidate: 60,
      },
